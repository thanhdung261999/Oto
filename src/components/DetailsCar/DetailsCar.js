...
import { BsCalendar3, BsFillBugFill, BsFlag } from "react-icons/bs";
    ...
    <div className="details-car-container">
      <div className="container">
        <div className="details-content">
          <div className="datails-des col-lg-8">
            <div className="content-main">
              ...
              <div className="car-details">
                <div className="car_details-content">
                  <div className="car_details-content-list">
                    <div className="car_details-content-item col-lg-4">
                      <div className="col-lg-7">
                        <AiOutlineCalendar className="icon" />
                        <span>Production year</span>
                      </div>
                      <span className="col-lg-5">
                        {data && data.publishing_year}
                      </span>
                    </div>
                    <div className="car_details-content-item col-lg-4">
                      <div className="col-lg-7">
                    ...
                    <div className="car_details-content-item col-lg-4">
                      ...
                      <span className="col-lg-5">
                        {data &&
                          data.km_traveled &&
                          new Intl.NumberFormat().format(data.km_traveled) +
                            " km"}
                      </span>
                    </div>
                    <div className="car_details-content-item col-lg-4">
              ...
              <div className="content-description">
                ...
                <div>
                  Commitment to customers in writing when buying a car at
                  Bussan:
                </div>
                <div>
                  - Commitment to the original car does not crash, flooded.
                </div>
                <div>- Many warranty and after-sales modes.</div>
                <div>
                  - Support all procedures for loans, transfer of names,
          ...
          <div className="details-intro col-lg-4">
